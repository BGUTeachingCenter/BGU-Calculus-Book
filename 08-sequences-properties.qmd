...
בפרק הקודם הגדרנו את המושג גבול של סדרה והבאנו מספר דוגמאות. בשלב הזה, כמו שהערנו, אנו יכולים לענות רק האם המספר $L$ הוא גבול של סדרה $a_n$, ולפעמים לשלול קיום גבול מתוך הגדרה, אבל אין לנו עדייו יכולת לענות לשאלות כגון: האם הגבול או קיים, או מה הוא הגבול כאשר הוא קיים. בפרק הזה את הכלים הבסיסיים שיעזרו לנו לענות לשאלות מהסוג הזה.
