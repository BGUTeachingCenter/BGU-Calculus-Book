...
::: {.content-visible when-format="html"}
![אי-רציפות ב-$x=2$ — $\lim_{x\to 2}f(x)=3$ אך $f(2)=4$](figures/c13_fig03.png){#fig-c04_fig17 width="62%" fig-align="center"}
:::
...
::: {.content-visible when-format="html"}
![שלוש דוגמאות למשפט ויירשטראס: (A) רציפה אך לא חסומה — אי אפשר ליישם; (B) רציפה על $[a,b]$ עם מקסימום ומינימום; (C) רציפה עם כמה $x_{\max}$ ו-$x_{\min}$ — אפשר ליישם](figures/c13_fig12.png){#fig-c05_fig11 width="62%" fig-align="center"}
:::
