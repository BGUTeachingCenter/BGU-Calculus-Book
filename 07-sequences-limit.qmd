...
::: {#box-key-eventually .thmkey icon="convention" title="מוסכמה: החל ממקום מסוים"}
...
::: {#box-key-splitting .thmkey title="פיצול טענות מהסוג ״החל ממקום מסוים״"}
...
::: {#box-key-finitely-many .thmkey title="שילוב טענות מהסוג ״החל ממקום מסוים״"}
