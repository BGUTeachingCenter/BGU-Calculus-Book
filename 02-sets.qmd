...
במילים אחרות, המשלים אינו אלא ה**הפרש מן העולם כולו**, $,U \setminus A$ שהוא מקרה פרטי של פעולת ההפרש. הוא גם המקבילה הקבוצתית של ה[שלילה](01-logic.qmd#sec-negation): מתקיים $x \in A^{c}$ אם ורק אם הפסוק $x \in A$ שקר.
